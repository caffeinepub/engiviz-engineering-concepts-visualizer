...
export class Backend implements backendInterface {
    ...
    async addConceptCategory(arg0: ConceptCategory): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addConceptCategory(arg0);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getAllConceptCategories(): Promise<Array<ConceptCategory>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllConceptCategories();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
